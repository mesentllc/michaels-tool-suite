...
public class RODeSGatewayFactory {
	private DataSource createDataSource() {
		BasicDataSource dataSource = new BasicDataSource();
		dataSource.setDriverClassName("oracle.jdbc.driver.OracleDriver");
		dataSource.setUrl("jdbc:oracle:thin:@ldap://oidprd.gss.ground.fedex.com:389/SPRODS_USR_SVC1_PRD,cn=OracleContext,dc=ground,dc=fedex,dc=com");
	...
	public RodesGateway createGateway() {
		return new RodesGatewayImpl(createDataSource());
	}
}
